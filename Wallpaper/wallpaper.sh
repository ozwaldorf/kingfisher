...
#Set Wallpaper
gsettings set org.gnome.desktop.background picture-uri '"file://'$folder'/'$file_name'"'
gsettings set org.gnome.desktop.screensaver picture-uri '"file://'$folder'/'$file_name'"'
